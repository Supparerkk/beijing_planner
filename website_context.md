...
**ตรวจสอบ code ล่าสุดเมื่อ:** 2026-09-09 (อ้างอิง commit `a3f2bba` บน branch `main`)
...
| `#day2` | วันที่ 2 · 18 ต.ค. | Mutianyu Great Wall | เหมือนด้านบน + `.attraction-callout` | เนื้อหา hardcode | ระดับ 🟥 เดินเยอะ |
| `#day3` | วันที่ 3 · 19 ต.ค. | Summer Palace + ตรอก Hutong/Houhai | เหมือนด้านบน | เนื้อหา hardcode | ระดับ 🟥 — ย้ายมาจากวันพุธเดิม เพื่อเลี่ยง Forbidden City ตกวันจันทร์ (ดู `#booking` และ section "Itinerary Review & Changes") |
...
| `#day5` | วันที่ 5 · 21 ต.ค. | Lama Temple + Confucius Temple + 798 Art + Sanlitun | เหมือนด้านบน | เนื้อหา hardcode | ระดับ 🟨 ปานกลาง |
...
| `#day7` | วันที่ 7 · 23 ต.ค. | Temple of Heaven + Wangfujing + โชว์กายกรรม Chaoyang Theatre | เหมือนด้านบน | เนื้อหา hardcode | ระดับ 🟨 ปานกลาง |
...
10. `.git log` — ประวัติการแก้ไขเนื้อหา (ใช้เข้าใจบริบทว่าทำไมเนื้อหาบางจุดถึงเป็นแบบนี้ เช่น ทำไม Forbidden City ถึงอยู่วันที่ 4 ไม่ใช่วันที่ 3)
